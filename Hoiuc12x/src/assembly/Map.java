...
public final class Map {
    ...
    public Map(int id, Cave cave, Dun dun, ChienTruong chienTruong, GiaTocChien giaTocChien, LanhDiaGiaToc lanhDiaGiaToc) {
...
//
    ...
    public void MobLienHang() {
        ...
        for (j = 0; j < this.area.length; j++) {
            ...
            for (i = 0; i < this.template.arMobid.length; ++i) {
                ...
                if (m.templates.id == 102 || m.templates.id == 103 || m.templates.id == 101 || m.templates.id == 100 || m.templates.id == 104) {
                    m.hpmax = 10000000;
                    m.hp = 10000000;
                }
                ...
                if (m.templates.id == 120 || m.templates.id == 117 || m.templates.id == 121 || m.templates.id == 119 || m.templates.id == 118) {
                    m.hpmax = 15000000;
                    m.hp = 15000000;
                }
                ...
                if (m.templates.id == 127 || m.templates.id == 126 || m.templates.id == 123 || m.templates.id == 124 || m.templates.id == 125 || m.templates.id == 128) {
                    m.hpmax = 20000000;
                    m.hp = 20000000;
                }
                if (m.templates.id == 194 || m.templates.id == 195 || m.templates.id == 193 || m.templates.id == 171 || m.templates.id == 179) {
                    m.hpmax = 50000000;
                    m.hp = 50000000;
                }
    ...
    public boolean mapChienTruong() {
        return this.id == 98 || this.id == 99 || this.id == 100 || this.id == 101 || this.id == 102 || this.id == 103 || this.id == 104;
    }
