...
public class ItemTemplate {
    ...
    public static final int[] checkPartHead = new int[]{214, 226, 229, 241, 244, 188, 185, 175, 177, 223, 254, 258, 261, 264, 267, 205, 201, 194, 185, 188, 232, 279, 276, 273, 270};
    public static final int[] check_id = new int[]{73, 102, 103, 105, 114, 115, 116, 117, 118, 119, 120, 121, 124, 125, 126};

    public static short[] idNewItems = new short[]{798, 801, 802, 803, 795, 796, 804, 805, 799, 800, 813, 814, 815, 816, 817, 825, 826, 828, 829, 830, 831, 839, 843, 844, 845, 846, 835, 856, 857, 858, 859, 860, 861, 797, 862, 863, 864, 865, 866, 881, 882, 883, 892, 894};

    public static short[][] idNewItemMounts = new short[][]{
        new short[]{798, 801, 802, 803, 828, 831, 856, 857},
        new short[]{36, 47, 48, 49, 63, 72, 117, 118}};
    public static short[][] idNewItemCaiTrang = new short[][]{
        new short[]{795, 796, 805, 804, 829, 830, 843, 844, 846, 845, 864, 865},
        new short[]{37, 40, 55, 58, 66, 69, 171, 174, 138, 126, 180, 183},
        new short[]{38, 41, 56, 59, 67, 67, 172, 175, 139, 127, 181, 184},
        new short[]{39, 42, 57, 60, 68, 68, 173, 176, 140, 128, 182, 185}
    };
    ...
    public static short[][] idNewItemMatNa = new short[][]{
        ...
        new short[]{50, 53, 52, 51, 54}};
    public static short[][] idNewItemYoroi = new short[][]{
        new short[]{797},
        new short[]{43}};
    public static short[][] idNewItemBienHinh = new short[][]{
        new short[]{825, 826, 839, 797, 866, 881, 882, 883, 892, 894},
        new short[]{61, 62, -1, 43, -1, -1, -1, -1, -1, -1}};
