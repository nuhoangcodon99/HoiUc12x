...
public class Dun {
    ...
    private void initMap() {
        this.map[0] = new Map(133, null, this, null, null, null);
        this.map[1] = new Map(111, null, this, null, null, null);
    }
            ...
            synchronized (this) {
                ...
                if (this.c1 == null && this.c2 != null) { //nếu người chơi c1 thoát
                    if (this.tienCuocTeam2 > 0) { //nếu người chơi c2 có tiền cược => trả lại tiền cược
                        ...
                        this.c2.p.sendAddchatYellow("Đối phương thoát, bạn nhận lại " + Util.getFormatNumber(this.tienCuocTeam2) + " xu. Bạn sẽ được đưa về trường sau 3s");
                    } else {
        ...
        if (this.isStart) { //isStart = true sẽ check liên tục về thông tin 2 đội đánh nhau trong lôi đài
            synchronized (this) {
                ...
                if (this.c1 == null && this.team1.size() < 1) {
                    ...
                    if (c2.taskId == 42 && c2.taskIndex == 1) {
                        c2.uptaskMaint();
                    }
                    int i;
                    ...
                    if (c1.taskId == 42 && c1.taskIndex == 1) {
                        c1.uptaskMaint();
                    }
                    int i;
                    for (i = 0; i < this.team1.size(); i++) {
